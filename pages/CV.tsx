    ...
    <Layout title="CV">
      <main>
        ...
        <p>
          ...
          of experience. As continuous learner, knowledge multiplayer and
          software gardener, I help teams increase productivity, establish
          continuous learning culture and steadily deliver customer value. I
          have both deep and broad expertise in software development practices.
          I'm an active member of various professional software development
          communities and occasional conference speaker on topics of interest
          and expertise. My interests include functional programming languages,
          systems thinking, organizational dynamics and coaching.
        </p>

        <h2>Skills</h2>
        <ul>
          <li>
            <strong>Lean</strong> and <strong>agile</strong> software
            development across all stages of the lifecycle including product and{" "}
            ...
            and <strong>continuous delivery</strong>. <strong>DevOps</strong>{" "}
            and automation of all repetitive tasks and quality gates.
          </li>
          <li>
          ...
          <li>
            Functional, reactive and object-oriented programming. Design
            patterns, clean code, test-driven development, refactoring, working
            with legacy code.
          </li>
          <li>
            ...
            <strong>microservices</strong> and data pipeline development.
            Project experience with <strong>Scala</strong>,{" "}
            <strong>Java</strong>, <strong>Clojure</strong>, <strong>F#</strong>
            , <strong>C#</strong>, <strong>TypeScript</strong>,{" "}
            <strong>JavaScript</strong>, <strong>Elm</strong>,{" "}
            <strong>HTML/CSS</strong>, <strong>SQL/NoSQL</strong> and many more.{" "}
            <strong>Cloud</strong> and <strong>PaaS</strong> environments.
          </li>
        </ul>
        ...
        <ul className="timeline">
          ...
          <li>
            ...
            <p>
              ...
              <strong>peer code reviews</strong>, regular architecture and
              design sessions. Hired and developed strong engineers. Ran
              initiative to containerize the application and replatform from
              enterprise application server on internal on-prem{" "}
            ...
            <p>
              ...
              owners. Helped to devise the business unit’s technical strategy
          ...
          <li>
            ...
            <p>
              ...
              <strong>Jenkins</strong>. Taught functional and reactive
              programming with <strong>Scala</strong> and <strong>Akka</strong>.
            </p>
          </li>
          ...
          <li>
            ...
            <p>
              ...
              <strong>Kanban</strong> and <strong>Scrum</strong>. Helped
              implement the <strong>continuous delivery</strong> pipeline using{" "}
              <strong>TeamCity</strong> and <strong>F#</strong> scripting tools.
              Coached developers in <strong>OO design principles</strong>,{" "}
              <strong>TDD</strong>, <strong>refactoring</strong> and working
              with <strong>legacy code</strong>.
            </p>
            <p>
              Designed and developed hypermedia <strong>web API</strong>
              and a high throughput event processing system for a telecom
              provider using <strong>Scala</strong>, <strong>Akka</strong>,{" "}
          ...
          <li>
            ...
            <p>
              ...
              people including product managers, testers, developers and
              technical writers. Trained and conducted{" "}
              <strong>workshops</strong> individually for each group of
              stakeholders and team members to ensure the lasting effect of
              agile transition. Introduced{" "}
          ...
          <li>
            ...
            <p>
              Developed line of business intranet and internet applications
              using <strong>ASP.NET</strong> technologies and{" "}
        ...
        <ul className="timeline">
          ...
          <li>
            <time>2021</time>
            Certified <strong>Practitioner of Human-Centered Design</strong>,
            LUMA Institute
          </li>
          <li>
            <time>2019</time>
          ...
          <li>
            ...
            <strong>Engineer of Information Technology</strong>, Novosibirsk
