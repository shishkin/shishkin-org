...
<Head>
  ...
  <meta
    name="description"
    content="Sergey Shishkin - technical consultant and coach specializing in business agility and technical excellence"
  />
</Head>
...
### <IoNavigateOutline className="icon" /> Business Agility
...
### <IoRocketOutline className="icon" /> Technical Excellence
...
### <IoTrailSignOutline className="icon" /> Consulting
...
### <IoConstructOutline className="icon" /> Development
...
### <IoShieldCheckmarkOutline className="icon" /> Architecture and Code Review
...
### <GrGrow className="icon" /> Interim Technical Leadership
...
### <IoEaselOutline className="icon" /> Training
...
### <IoChatbubblesOutline className="icon" /> Coaching
